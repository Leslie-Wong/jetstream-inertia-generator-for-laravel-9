    ...
    <jig-layout>
        ...
        <div v-if="can.viewAny" class="flex flex-wrap px-4">
            <div class="z-10 flex-auto bg-white md:rounded-md md:shadow-md">
                <h3 class="w-full p-4 mb-2 text-lg font-black sm:rounded-t-lg bg-primary-100"><i class="mr-2 fas fa-bars"></i> {{__('{{__('List of All')}}')}}
        ...
        {{__('{{__('You are not authorized to view a list of')}}')}} {{$modelTitlePlural}}
        </div>
    </jig-layout>
</template>
